...
- Les [libellés]({{ site.url }}/fall-16#nouvelles-thmatiques) utilsés pour afficher des codes postaux
...
Ah, j'oubliais, si vous aussi vous vous posiez la question, [Galigeo for Salesforce fonctionne parfaitement dans Lightning](http://www.galigeo.com/fr/galigeo-salesforce-est-lightning-ready/).
